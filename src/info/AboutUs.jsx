      ...
      <section className="lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 text-center">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: muted }}>
            SkipQ was born out of frustration — too many hours lost in queues at
            banks and government offices. We built the tool we always wished
            existed.
          </p>
        </motion.div>
      </section>
      ...
      <section className="lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <p className="text-3xl font-black" style={{ color: "#410fc7" }}>
                {stat.value}
              </p>
